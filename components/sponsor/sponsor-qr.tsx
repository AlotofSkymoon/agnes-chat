...
function ChannelCard({ channel }: { channel: SponsorChannel }) {
  ...
  return (
    /*
     * Aceternity 的高光卡片：指针附近有柔光 + 边缘亮线。
     *
     * ⚠️ 为什么这里不能用主题色变量：
     * 赞助页背景是深色云层（WebGL），浅色主题下 text-fg-secondary 是深灰，
     * 放在深色卡片上几乎看不见。所以这一块的文字统一用浅色，不跟主题走。
     */
      ...
      <div className="w-full p-5">
        {failed ? (
          <div className="flex flex-col items-center gap-2.5 py-6 text-center">
            ...
            <p className="text-sm font-medium text-white">{channel.name} 收款码暂未配置</p>
